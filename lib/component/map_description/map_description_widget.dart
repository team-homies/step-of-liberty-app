...
import 'map_description_model.dart';
export 'map_description_model.dart';

class MapDescriptionWidget extends StatefulWidget {
  const MapDescriptionWidget({super.key});

  @override
  State<MapDescriptionWidget> createState() => _MapDescriptionWidgetState();
}

class _MapDescriptionWidgetState extends State<MapDescriptionWidget> {
  late MapDescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapDescriptionModel());
  }
